...
{   
    ...
    //反照率(sRGB)
    vec3  albedo =pow(texture(diffuse_map, fs_in.uv).rgb,vec3(2.2f)) ;
    //金属度（线性空间）
    ...
    //视线方向
    vec3 viewDir = normalize(cameraPos - fs_in.vs_position);
    //反射方向
